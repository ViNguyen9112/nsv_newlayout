...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Report Category</h6>
        <button type="button" class="btn btn-success rounded-pill float-right" id="show-modal-config-type"><i class="fas fa-plus"></i> Add Category</button>
    </div>
                            ...
                            <th scope="row" style="padding-right: 0px;">
                                <div class="form-group  mb-2">
                                    <div class="form-group  " style="width:340px">
                                        <span style="color:#000;margin-right:3px;font-size:14px; width:60px; text-align:left ">Type</span>
                            ...
                            <th scope="row">
                                <div class="form-group" style="width:200px;padding-top: 8px">
                                    <label class="checkbox">
                                        <input  type="checkbox" name="showDeleted" class="checkDelete" value="1" />&nbsp;&nbsp;&nbsp;Show Deleted Category
                                    </label>
                                </div>
                            </th>
                            <th scope="row">
        ...
        <div class="row ">
            <div class="col-md-12  mx-auto text-center form p-8">
                ...
                <tr>
                    ...
                    <th class="w-td2">Category Code</th>                    
                    <th class="text-left">English</th>
                    <th class="text-left">Japanese</th>
                    <th class="text-left">Native language</th>
                    <th class="text-left">Type</th>
                    <th class="text-left">Type Of Category</th>
                    <th class="text-center w-td2" >Sort</th>
                    <th class="text-center">Hide</th>
                    <th class="w-td100"></th>
                </tr>
                </thead>
                <tbody id="tblConfigCategory">
                <!--datatable-->
                </tbody>
            </table>
        </div>
...
<?php echo $this->element('Admin/popup_config_category'); ?>
...
echo $this->Html->script('admin/config_category/index.js?v=' . date('YmdHis'), ['block' => 'scriptBottom']);
?>
