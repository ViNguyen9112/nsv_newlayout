...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Over Time Management</h6>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="serverDataTable" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <th>End time</th>
                    <th>Total</th>
                    <th style="min-width:200px; width:auto">Status</th>
                </tr>
                </thead>
...
?>
<?= $this->Html->script('admin/alsok/overtime.js?v='. date('YmdHis'), ['block' => 'scriptBottom']) . PHP_EOL ?>
